...
class Sinusbot {
    constructor() {
        ...
        this.backend = new backend_1.Backend(this);
        this.event = new event_1.Event(this);
        this.format = new format_1.Format(this);
    }
    createClient() {
        const client = new Client_1.Client(this);
        return client;
    }
    createChannel() {
        const channel = new Channel_1.Channel(this);
        return channel;
    }
    /**
